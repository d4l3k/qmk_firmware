...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[FN] = LAYOUT(
		KC_TAB, KC__MUTE, KC_VOLD, KC_VOLU, KC_MPLY, KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_NO,
		KC_ESC, KC_NO, KC_NO, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_BSPC,
	...
	[FKEYS] = LAYOUT(
		...
		KC_F11,KC_F12,KC_NO,RGB_TOG,RGB_MOD,RGB_VAI,RGB_VAD,KC_NO,RESET,KC_DEL,
